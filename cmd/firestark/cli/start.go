...
var StartCmd = &cobra.Command{Use: "start", Short: "Starts `firestark` services all at once", RunE: firehoseCmdStartE, Args: cobra.ArbitraryArgs}
...
func firehoseCmdStartE(cmd *cobra.Command, args []string) (err error) {
	...
	rootLog.Debug("firestark binary started", zap.String("data_dir", dataDir))
